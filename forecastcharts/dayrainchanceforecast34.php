...
if (weather34value>=40 && weather34value<=100) {thecolor='hsla(185, 100%, 37%, .8)';}  
else if (weather34value>=20 && weather34value<40) {thecolor='hsla(185, 100%, 37%, .4)';} 
else if (weather34value>=10 && weather34value<20) {thecolor='hsla(185, 100%, 37%, .2)';}           
else {thecolor='hsla(185, 100%, 37%, 0)';}
return thecolor;}
...
<body>
<div class="modulecaption" >Precipitation Forecast </div>
<div class="unitscaption" >%</div>
