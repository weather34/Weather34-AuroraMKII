...
if (weather34value>=0 && weather34value<=2) {thecolor='hsla(185, 100%, 37%, 1)';}
else if (weather34value>2 && weather34value<=5) {thecolor='hsl(75, 62%, 43%)';}
else if (weather34value>5 && weather34value<=8) {thecolor='hsl(35, 77%, 58%)';}
else if (weather34value>8 && weather34value<=13) {thecolor='hsl(19, 66%, 55%)';}  
else if (weather34value>13 && weather34value<=200) {thecolor='hsl(2, 56%, 55%)';}            
