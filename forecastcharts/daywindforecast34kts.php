...
else if (weather34value>6 && weather34value<=11) {thecolor='hsl(75, 62%, 43%)';}
else if (weather34value>11 && weather34value<=16) {thecolor='hsl(35, 77%, 58%)';}
else if (weather34value>16 && weather34value<=27) {thecolor='hsl(19, 66%, 55%)';}  
else if (weather34value>27 && weather34value<=200) {thecolor='hsl(2, 56%, 55%)';}            
