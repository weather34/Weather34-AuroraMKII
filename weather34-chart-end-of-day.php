...
// [DD][MM] , [th0temp-ydmax:--] , [th0temp-ydmin:--] , [th0dew-ydmax:--] , [th0dew-ydmin:--] , [rain0total-ydmax:--] , [wind0wind-ydmax:--] , [wind0wind-ydavg:—] , [position 8 not used] ,  [thb0seapress-ydmax:--] , [thb0seapress-ydmin:--] ,  [uv0index-ydmax:--] , [sol0rad-ydmax:--] , [air0pm-ydavg:—] , [air1pm-ydavg:—] , [wind0dir-ydavg:--] ,$weather["humidity_ydmax"] ,$weather["humidity_ydmin"]
$weatherchartfilemonth ="weather34charts/".$year."/".date('F').".csv";
$weather34chartdata = date('j M',strtotime("-1 day")).",".$meteobridgeapi[82].",".$meteobridgeapi[84].",".$meteobridgeapi[52].",".$meteobridgeapi[120].",".$meteobridgeapi[100].",".$meteobridgeapi[94].",".$meteobridgeapi[123].",".$meteobridgeapi[123].",".$meteobridgeapi[135].",".$meteobridgeapi[137].",".$meteobridgeapi[114].",".$meteobridgeapi[107].",".$aqiweather["aqi24h"].",".$meteobridgeapi[184].",".$meteobridgeapi[171].",".$meteobridgeapi[167].",".$meteobridgeapi[169].""."\r\n";
