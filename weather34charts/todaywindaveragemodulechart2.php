		...
		if(allLinesArray.length>0){
			...
			for (var i = 0; i <= allLinesArray.length-1; i++) {
				...
				if ( rowData[2] >-50)
					...
					dataPoints2.push({label: rowData[1],y:parseFloat(rowData[7]*<?php echo $conv ;?>),color:WEATHER34CHARTCOLORS(parseFloat(rowData[7]*<?php echo $conv ;?>))});
...
<div class="modulecaptionchart3">Average Wind Speed (<?php echo $windunit ;?>) <?php echo date('l F jS')?></div> 
