		...
		if(allLinesArray.length>0){
			...
			for (var i = 0; i <= allLinesArray.length-1; i++) {
				...
				if ( rowData[2] >-150)
					...
					dataPoints1.push({label: rowData[1],y:parseFloat(rowData[7]*<?php echo $conv ;?>),color:WEATHER34CHARTCOLORS(parseFloat(rowData[7]*<?php echo $conv ;?>))});
	...
	function processData2(allText) {
	  ...
	  margin: 0,
		...
		data: [
		{
			...
			showInLegend:false,
			fillOpacity: .8,
			name:"10 Min Average Wind Speed",
