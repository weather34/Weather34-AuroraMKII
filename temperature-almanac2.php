...
<?php  //month max
echo "".date('F')." <orange>Max</orange>  ".$weather["tempmmaxtime"];echo " ";
...
<div class="alamanacdata">
<?php  //year min
echo "".date('Y')."  <deepblue>Min</deepblue> ".$weather["tempymintime"];echo " ";
...
<div class="alamanacdata">
<?php  //alltime max
echo "Alltime <orange>Max</orange> ".$weather["tempamaxtime"];echo " ";
...
<div class="alamanacdata">
<?php  //alltime min
echo "Alltime <deepblue>Min</deepblue> ".$weather["tempamintime"];echo " ";
