...
include('updaterhome-air-luftdaten.php');
...
<div class="humidityfeel" style="left:5px">Feels &nbsp;
<?php //pa temp
...
<article> 
<div class=actualt>Indoor Air Quality (<blue>Lufdaten</blue>)</div> 
<div class="button button-dial-small">   
   <div class="button-dial-top-small"></div>
<div class="button-dial-label-small"> 
<?php //AQI
...
<div class="humidityfeel" style="left:20px;">
<?php 
//air description
echo '';
if ($aqiweather["aqindex"] >=300){echo "<purple>Hazordous</purple>".$aqalert;}
else if ($aqiweather["aqindex"] >=250){echo "<deepred>Very Unhealthy</deepred>".$aqalertsmall;}
else if ($aqiweather["aqindex"] >=200){echo "<red>Very Unhealthy</red>".$aqalertsmall;}
else if ($aqiweather["aqindex"] >=150){echo "<red>Unhealthy</red>".$aqalertsmall;}
else if ($aqiweather["aqindex"] >=100){echo "<orange>Poor</orange>";}
else if ($aqiweather["aqindex"] >=50){echo "<yellow>Moderate</yellow>";}
else if ($aqiweather["aqindex"] >0){echo "<green>Good</green>";}
