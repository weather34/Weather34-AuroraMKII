...
echo '<wudir3day>'.$weather34compassiconwu .$wuskydayWinddircardinal.'</wudir3day>';
echo '<wuwind3day>';echo "<blue>".$weather34_wind_iconwu."</blue>&nbsp; ";
if ($wuskydayWindGust>=70) {echo "<purple>".number_format($wuskydayWindGust,0)."</purple> ";}
else if ($wuskydayWindGust>=50) {echo "<red>".number_format($wuskydayWindGust,0)."</red> ";}
else if ($wuskydayWindGust>=35) {echo "<orange>".number_format($wuskydayWindGust,0)."</orange> ";}
...
if ($wuskythunder>0 )  {echo "<orange>Thunderstorm</orange>".$wuskydayTime.'&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder1>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime1. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder2>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime2. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder3>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime3. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder4>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime4. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder5>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime5. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder6>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime6. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder7>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime7. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder8>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime8. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder9>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime9. '&nbsp;'.$lightningalert8.'';}
else if ($wuskythunder10>0 )  {echo ' <orange>Thunderstorm</orange>	 '.$wuskydayTime10. '&nbsp;'.$lightningalert8.'';}
//snowfall wu
