...
else if (number_format($weather["humidity_davg"],0)<=25){echo $weather["humidity_davg"]/20.5;}
else if (number_format($weather["humidity_davg"],0)<=35){echo $weather["humidity_davg"]/19.25;}
else if (number_format($weather["humidity_davg"],0)<=50){echo $weather["humidity_davg"]/20.75;}
else if (number_format($weather["humidity_davg"],0)<=60){echo $weather["humidity_davg"]/19.75;}
else if (number_format($weather["humidity_davg"],0)<=70){echo $weather["humidity_davg"]/20.75;}
else if (number_format($weather["humidity_davg"],0)<=75){echo $weather["humidity_davg"]/20.5;}
else if (number_format($weather["humidity_davg"],0)<=80){echo $weather["humidity_davg"]/19;}
else if (number_format($weather["humidity_davg"],0)<=90){echo $weather["humidity_davg"]/19;}
