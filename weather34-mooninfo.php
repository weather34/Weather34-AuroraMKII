...
class Moon{ public static function calculateMoonTimes($month,$day,$year,$lat,$lon){$utrise=$utset=0;$timezone=(int)($lon / 15);
  ...
  .weather34moonsvgmoon {
    fill: rgba(145, 157, 163, 0.<?php if ($weather['luminance']==100){echo '99';}else echo $weather['luminance'];  ?>);
...
grey{color:#ccc}
  ...
  <main class="grid">
    <article>  
  <?php echo $info;?> Moon Phase<br><br>  
...
function moon_day(today) {    
  ...
  $weather34julian = $weather34julian / 29.530589;
  ...
  //2021 lunar events 
  if($day===date("l jS F Y",strtotime('2021-4-30'))){echo 'Event: Partial Solar <deepblue>Eclipse</deepblue>';}
  else if($day===date("l jS F Y",strtotime('2021-5-15'))){echo 'Event: Lunar <deepblue>Eclipse</deepblue>';}
  else if($day===date("l jS F Y",strtotime('2021-5-26'))){echo 'Event: Total Lunar <deepblue>Eclipse</deepblue>';}	
  else if($day===date("l jS F Y",strtotime('2021-6-10'))){echo 'Event: Lunar <deepblue>Eclipse</deepblue>';}
  else if($day===date("l jS F Y",strtotime('2021-11-18'))){echo 'Event: Partial Lunar <deepblue>Eclipse</deepblue>';}
  else if($day===date("l jS F Y",strtotime('2021-12-4'))){echo 'Event: Total <deepblue>Eclipse</deepblue>';}
  // weather34 moonphase no scraping its calculated from the script above weather34lunar_phase !
    else echo "Current Phase<br>".$weather34lunar_phase;}?><br>
    Luminance:<?php echo $weather['luminance'];?>%
    ...
    </svg> Moon Rise: <?php echo $weather['moonrise']," ";?>
    <br>
    ...
    </svg> Moon Set: <?php echo $weather['moonset']," ";?>
    </div> 
  </article>  
    <article> 
   <moonphaseriseset>
