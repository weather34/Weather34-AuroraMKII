...
include('livedata.php');
	...
	# 	                                                                                               #
	# 	                                                                                               #
	# 	FORECAST WU WEATHER FORECAST: Original FEB 2019	(Updated Jul 2019)  			               #
	# 	                                                                                               #
...
blueu,yellowu,orangeu,greenu,redu,purpleu{color:#fff;border-radius:2px;padding:0 3px 0 3px;align-items:center;justify-content:center;}summary{font-size:.9em;color:#aaa;display:none}blue1{color:#009bb4}value{font-size:.95em;color:#aaa}valuer{color:#aaa;font-size:.9em;}thunder{font-size:.9em;color:#aaa;margin-right:5px}wind{color:#bbb;font-size:.9em}
canvas,img,iframe,svg{image-rendering:auto;}
.mbsmartlogo{position:relative;float:right;top:25px;}
.tempalerticon{position:absolute;margin-top:-36px;margin-left:215px}
@media screen and (max-width:760px){
	.tempalerticon{display:none}
}
...
<?php echo '&nbsp;';echo "Forecast Updated &nbsp;".date( $timeformat, $forecastime);?>
  ">
</div>  
<main class="grid">
  <article>  
 ...
 //temp				  
	...
	//high temp icon
	if ($wuskydaynight=='D'){
	if( $tempunit=='F' && $wuskydayTempHigh>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
	else if( $tempunit=='C' && $wuskydayTempHigh>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
	}
	if ($wuskydaynight=='N'){							
	if( $tempunit=='F' && $wuskydayTempHigh>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
	if( $tempunit=='C' && $wuskydayTempHigh>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
	}


	//icon        
	echo"<div class=iconpos> ";      		  			  
	if ($wuskydaynight=='D'){echo '<img src="wuicons/'.$wuskydayIcon.'.svg" width="35" class="iconpos"></img></div>';}
	if ($wuskydaynight=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary of icon
 ...
 //temp				  
	...
	//high temp icon
	if ($wuskydaynight1=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh1>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh1>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight1=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh1>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh1>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
	//icon        
	echo"<div class=iconpos> ";      		  			  
	if ($wuskydaynight1=='D'){echo '<img src="wuicons/'.$wuskydayIcon1.'.svg" width="35" class="iconpos"></img></div>';}
	if ($wuskydaynight1=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon1.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary of icon
 ...
 //temp				  
	...
	//high temp icon
	if ($wuskydaynight2=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh2>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh2>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight2=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh2>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh2>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
	//icon        
	echo"<div class=iconpos> ";      		  			  
	if ($wuskydaynight2=='D'){echo '<img src="wuicons/'.$wuskydayIcon2.'.svg" width="35" class="iconpos"></img></div>';}
	if ($wuskydaynight2=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon2.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary of icon
 ...
 //temp				  
	...
	//high temp icon
	if ($wuskydaynight3=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh3>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh3>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight3=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh3>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh3>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
	//icon        
	echo"<div class=iconpos> ";      		  			  
	if ($wuskydaynight3=='D'){echo '<img src="wuicons/'.$wuskydayIcon3.'.svg" width="35" class="iconpos"></img></div>';}
	if ($wuskydaynight3=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon3.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary of icon
 ...
 <article>  
	...
	//high temp icon
	if ($wuskydaynight4=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh4>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh4>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight4=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh4>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh4>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
	//icon        
	echo"<div class=iconpos> ";      		  			  
	if ($wuskydaynight4=='D'){echo '<img src="wuicons/'.$wuskydayIcon4.'.svg" width="35" class="iconpos"></img></div>';}
	if ($wuskydaynight4=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon4.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary of icon
...
<article>  
	...
	//high temp icon
	if ($wuskydaynight5=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh5>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh5>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight5=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh5>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh5>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
	//icon        
	echo"<div class=iconpos> ";      		  			  
	if ($wuskydaynight5=='D'){echo '<img src="wuicons/'.$wuskydayIcon5.'.svg" width="35" class="iconpos"></img></div>';}
	if ($wuskydaynight5=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon5.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary of icon
  ...
  <article>
	...
	//high temp icon
	if ($wuskydaynight6=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh6>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh6>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight6=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh6>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh6>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
echo"<div class=iconpos> ";      		  			  
if ($wuskydaynight6=='D'){echo '<img src="wuicons/'.$wuskydayIcon6.'.svg" width="35" class="iconpos"></img></div>';}
if ($wuskydaynight6=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon6.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary icon
  ...
  <article>
	...
	//high temp icon
	if ($wuskydaynight7=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh7>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh7>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight7=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh7>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh7>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
echo"<div class=iconpos> ";      		  			  
if ($wuskydaynight7=='D'){echo '<img src="wuicons/'.$wuskydayIcon7.'.svg" width="35" class="iconpos"></img></div>';}
if ($wuskydaynight7=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon7.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary icon
  ...
  <article>
	...
	//high temp icon
	if ($wuskydaynight8=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh8>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh8>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight8=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh8>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh8>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
echo"<div class=iconpos> ";      		  			  
if ($wuskydaynight8=='D'){echo '<img src="wuicons/'.$wuskydayIcon8.'.svg" width="35" class="iconpos"></img></div>';}
if ($wuskydaynight8=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon8.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary icon
  ...
  <article>
	...
	//high temp icon
	if ($wuskydaynight9=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh9>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh9>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight9=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh9>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh9>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
echo"<div class=iconpos> ";      		  			  
if ($wuskydaynight9=='D'){echo '<img src="wuicons/'.$wuskydayIcon9.'.svg" width="35" class="iconpos"></img></div>';}
if ($wuskydaynight9=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon9.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary icon
  ...
  <actualt><?php echo $wuskydayTime10 ?></actualt>         
	...
	if ($wuskydaynight10=='D'){
		if( $tempunit=='F' && $wuskydayTempHigh10>=82){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		else if( $tempunit=='C' && $wuskydayTempHigh10>=28){echo "<img src='aqi/daywarm.svg' width='40px' class='tempalerticon'> " ;}
		}
		if ($wuskydaynight10=='N'){							
		if( $tempunit=='F' && $wuskydayTempHigh10>=71){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		if( $tempunit=='C' && $wuskydayTempHigh10>=22){echo "<img src='aqi/nightwarm.svg' width='40px' class='tempalerticon'> " ;}
		}
echo"<div class=iconpos> ";      		  			  
if ($wuskydaynight10=='D'){echo '<img src="wuicons/'.$wuskydayIcon10.'.svg" width="35" class="iconpos"></img></div>';}
if ($wuskydaynight10=='N'){echo '<img src="wuicons/nt_'.$wuskydayIcon10.'.svg" width="35" class="iconpos"></img></div>';}
	 //summary icon
