...
(function(a){a(document).ready(function(){a.ajaxSetup({cache:true,success:function(){a("#position10").show()}});var c=a("#position10");c.load("weather34-dayforecast-home.php");var b=setInterval(function(){c.load("weather34-dayforecast-home.php")},80000)})})(jQuery);
